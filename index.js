...
// submodules/c2.js/dist/c2.js
var require_c2 = __commonJS((exports, module) => {
  (function(f) {
    ...
    return function() {
      ...
      exports3.Analyser = exports3.Sound = exports3.AudioIn = undefined;
      let audioContext;
      ...
      exports3.Analyser = Analyser;
    }, {}], 2: [function(require2, module3, exports3) {
      Object.defineProperty(exports3, "__esModule", { value: true });
      exports3.Neuron = exports3.NeuralNet = exports3.Mutation = exports3.Crossover = exports3.Chromosome = exports3.Population = undefined;
      ...
      exports3.Population = Population;
      ...
      exports3.Chromosome = Chromosome;
      ...
      exports3.Mutation = Mutation;
      Mutation.maxDeviation = 0.1;
      ...
      exports3.Neuron = Neuron;
    }, {}], 3: [function(require2, module3, exports3) {
      Object.defineProperty(exports3, "__esModule", { value: true });
      exports3.Cell = exports3.CellVertex = exports3.LimitedVoronoi = exports3.Voronoi = exports3.Delaunay = exports3.ConvexHull = exports3.QuadTree = exports3.Polygon = exports3.Rect = exports3.Triangle = exports3.Circle = exports3.Sector = exports3.Spline = exports3.Polyline = exports3.Arc = exports3.Line = exports3.Point = exports3.Vector = undefined;
      ...
      class Spline {
        ...
        point(p1, p2, p3, p4, t) {
          let p = (p12, p22, t1, t2) => new Point(p12.x * t1 + p22.x * t2, p12.y * t1 + p22.y * t2);
        ...
        tangent(p1, p2, p3, p4, t) {
          ...
          let b = this.point(p1, p2, p3, p4, t + 0.000001);
      ...
      class Rect {
        ...
        intersects(s) {
          if (s instanceof Point) {
            ...
            return this.p.x <= s.p.x + s.w && this.p.x + this.w >= s.p.x && this.p.y <= s.p.y + s.h && this.p.y + this.h >= s.p.y;
          }
        }
        intersection(rect) {
      ...
      exports3.ConvexHull = ConvexHull;
      ...
      class Delaunay {
        compute(points) {
          ...
          let x = (left + right) / 2;
          let y = (top + bottom) / 2;
          let p1 = new Point(x + 1e7, y);
          let p2 = new Point(x - 5000000, y + 1e7);
          let p3 = new Point(x - 5000000, y - 1e7);
          ...
          for (let i = triangles.length - 1;i >= 0; i--) {
            let t = triangles[i];
            if (t.p1 == superTriangle.p1 || t.p1 == superTriangle.p2 || t.p1 == superTriangle.p3 || (t.p2 == superTriangle.p1 || t.p2 == superTriangle.p2 || t.p2 == superTriangle.p3) || (t.p3 == superTriangle.p1 || t.p3 == superTriangle.p2 || t.p3 == superTriangle.p3)) {
      ...
      class Voronoi {
        compute(points) {
          ...
          for (let i = 0;i < triangles.length; i++) {
            ...
            for (let j = 0;j < i; j++) {
              let t2 = triangles[j];
              if (t1.p1 == t2.p1 && t1.p2 == t2.p2 || t1.p1 == t2.p2 && t1.p2 == t2.p1 || (t1.p1 == t2.p2 && t1.p2 == t2.p3 || t1.p1 == t2.p3 && t1.p2 == t2.p2) || (t1.p1 == t2.p3 && t1.p2 == t2.p1 || t1.p1 == t2.p1 && t1.p2 == t2.p3) || (t1.p2 == t2.p1 && t1.p3 == t2.p2 || t1.p2 == t2.p2 && t1.p3 == t2.p1) || (t1.p2 == t2.p2 && t1.p3 == t2.p3 || t1.p2 == t2.p3 && t1.p3 == t2.p2) || (t1.p2 == t2.p3 && t1.p3 == t2.p1 || t1.p2 == t2.p1 && t1.p3 == t2.p3) || (t1.p3 == t2.p1 && t1.p1 == t2.p2 || t1.p3 == t2.p2 && t1.p1 == t2.p1) || (t1.p3 == t2.p2 && t1.p1 == t2.p3 || t1.p3 == t2.p3 && t1.p1 == t2.p2) || (t1.p3 == t2.p3 && t1.p1 == t2.p1 || t1.p3 == t2.p1 && t1.p1 == t2.p3)) {
      ...
      exports3.LimitedVoronoi = LimitedVoronoi;
      ...
      exports3.CellVertex = CellVertex;
      ...
      Object.defineProperty(exports3, "__esModule", { value: true });
      __exportStar(require2("./math"), exports3);
      __exportStar(require2("./geometry"), exports3);
      __exportStar(require2("./physics"), exports3);
      __exportStar(require2("./evolution"), exports3);
      __exportStar(require2("./audio"), exports3);
      __exportStar(require2("./visual"), exports3);
    }, { "./audio": 1, "./evolution": 2, "./geometry": 3, "./math": 5, "./physics": 6, "./visual": 7 }], 5: [function(require2, module3, exports3) {
      Object.defineProperty(exports3, "__esModule", { value: true });
      exports3.Perlin = exports3.Random = exports3.deviation = exports3.variance = exports3.median = exports3.mean = exports3.sum = exports3.min = exports3.max = exports3.dist = exports3.norm = exports3.map = exports3.lerp = exports3.clamp = exports3.fract = exports3.rad = exports3.deg = undefined;
      function deg(rad2) {
        return rad2 / Math.PI * 180;
      }
      exports3.deg = deg;
      function rad(deg2) {
        return deg2 / 180 * Math.PI;
      }
      exports3.rad = rad;
      function fract(x) {
        return x - Math.floor(x);
      }
      exports3.fract = fract;
      function clamp(value, min2, max2) {
        return Math.max(min2, Math.min(value, max2));
      }
      exports3.clamp = clamp;
      ...
      function variance(data) {
        ...
        let sum2 = 0;
        for (let i = 0;i < data.length; i++)
          sum2 += (data[i] - m) * (data[i] - m);
        return sum2 / data.length;
      }
      ...
      exports3.Perlin = Perlin;
    }, {}], 6: [function(require2, module3, exports3) {
      Object.defineProperty(exports3, "__esModule", { value: true });
      exports3.PolygonConstraint = exports3.RectConstraint = exports3.CircleConstraint = exports3.Constraint = exports3.Gravitation = exports3.Collision = exports3.InteractionForce = exports3.CircleField = exports3.ArcField = exports3.LineField = exports3.PointField = exports3.ConstForce = exports3.Force = exports3.Spring = exports3.Particle = exports3.World = undefined;
      const geometry_1 = require2("./geometry");
      ...
      exports3.Spring = Spring;

      class Force {
      }
      exports3.Force = Force;
      ...
      exports3.ConstForce = ConstForce;
      ...
      class PointField extends Force {
        ...
        force(position) {
          ...
          if (d >= this._min && d <= this._max) {
            ...
            force = force.normalize().mult(1 - a * a / (b * b));
      ...
      exports3.PointField = PointField;
      ...
      exports3.CircleField = CircleField;

      class InteractionForce {
      }
      exports3.InteractionForce = InteractionForce;
      ...
      exports3.Gravitation = Gravitation;

      class Constraint {
      }
      exports3.Constraint = Constraint;
      ...
      exports3.CircleConstraint = CircleConstraint;
      ...
      exports3.RectConstraint = RectConstraint;
      ...
      exports3.PolygonConstraint = PolygonConstraint;
    }, { "./geometry": 3 }], 7: [function(require2, module3, exports3) {
      Object.defineProperty(exports3, "__esModule", { value: true });
      exports3.Color = exports3.Renderer = undefined;
      const geometry_1 = require2("./geometry");
...
// index.ts
var import_c2 = __toESM(require_c2(), 1);
var renderer = new import_c2.default.Renderer(document.getElementById("c2"));
resize();
...
var random = new import_c2.default.Random;
var color1 = import_c2.default.Color.hsl(random.next(0, 30), random.next(30, 60), random.next(20, 100));
var color2 = import_c2.default.Color.hsl(random.next(0, 30), random.next(30, 60), random.next(20, 100));
var color3 = import_c2.default.Color.hsl(random.next(0, 30), random.next(30, 60), random.next(20, 100));
var analyser;
var audioIn;
renderer.on("mousedown", () => {
  if (typeof audioIn === "undefined") {
    audioIn = new import_c2.default.AudioIn(function() {
      analyser = new import_c2.default.Analyser;
...
renderer.draw(() => {
  ...
  renderer.beginPath();
  for (let i = 0;i < timeDomain.length; i++) {
    let x = import_c2.default.map(i, 0, timeDomain.length, 0, renderer.width);
  ...
  renderer.beginPath();
  for (let i = 0;i < freqDomain.length; i++) {
    let x = import_c2.default.map(i, 0, freqDomain.length, 0, renderer.width);
