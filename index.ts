import c2 from "./submodules/c2.js";


const renderer: c2.Renderer = new c2.Renderer(document.getElementById('c2'));
resize();
...
let color1 = c2.Color.hsl(random.next(0, 30), random.next(30, 60), random.next(20, 100));
let color2 = c2.Color.hsl(random.next(0, 30), random.next(30, 60), random.next(20, 100));
let color3 = c2.Color.hsl(random.next(0, 30), random.next(30, 60), random.next(20, 100));



let analyser: undefined | typeof c2.Analyser;

let audioIn : undefined | typeof c2.AudioIn;
